...
curl https://raw.githubusercontent.com/mikkokotila/Padma-Infra/test.padma.io/Padma-API.conf > Padma-API.conf
curl https://raw.githubusercontent.com/mikkokotila/Padma-Infra/test.padma.io/Padma-Frontend.conf > Padma-Frontend.conf
