...
curl https://raw.githubusercontent.com/mikkokotila/Padma-Infra/staging.padma.io/Padma-API.conf > Padma-API.conf
curl https://raw.githubusercontent.com/mikkokotila/Padma-Infra/staging.padma.io/Padma-Frontend.conf > Padma-Frontend.conf
